...
public class ConsultationService {
    ...
    public Consultation assignForConsultation( TestRequest testRequest, User doctor) {
        ...
        //assigning doctor and test request to this object
    ...
    public Consultation updateConsultation(TestRequest testRequest , CreateConsultationRequest createConsultationRequest) {
        ...
        //find consultation from database
        Consultation consultation = consultationRepository.findByRequest(testRequest).orElseThrow(() -> new AppException("Unable to find consultation for this test request"));;

        //set consultation values from user input (doctor)
